...
// export a create function for the bot that takes a connector object
// this enables us to swap out a normal ChatConnector for a ConsoleConnector
// that allows to test more easily (ConsoleConnector doesn't need an external connection)
function create(connector) {
    ...
    // remember to return bot object so tests can use this 
...
var getSentimentAnalysis = function(text, cb) {
